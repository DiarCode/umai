...
import DiscountCard from '../composables/DiscountCard.vue'
import DishCard from '../composables/DishCard.vue'
import CategoriesSlider from '../composables/CategoriesSlider.vue'
import { mockCategories } from '../services/categoriesService'
import { mockMenu } from '../../dish/services/menuService'
...
const filteredDishes = computed(() => {
  ...
  return allDishes.filter(
    dish => dish.categoryId === activeCategory.value
  )
})
</script>
  ...
  <div class="space-y-8 bg-gray-50">
    ...
    <section>
        <div class="flex items-center mr-3">
            <img :src="Fire" alt="Hot" class="w-5 h-5 inline-block mr-1"/>
